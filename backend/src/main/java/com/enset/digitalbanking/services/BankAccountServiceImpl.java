...
import com.enset.digitalbanking.mappers.BankAccountMapperImpl;
...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    public SavingBankAccountDTO saveSavingBankAccount(double initialBalance, double interestRate, Long customerId) throws CustomerNotFoundException {
        ...
        return dtoMapper.fromSavingAccountDTO(savedBankAccount);
    }
    ...
    public BankAccountDTO getBankAccount(String accountId) throws BankAccountNotFoundException {
        ...
        if(bankAccount instanceof SavingAccount) {
            ...
            return dtoMapper.fromSavingAccountDTO(savingAccount);
        } else {
    ...
    public void transfer(String accountIdSource, String accountIdDestination, double amount) throws BankAccountNotFoundException, BalanceNotSufficientException {
        ...
        credit(accountIdDestination, amount, "Transfert from " + accountIdDestination);
    }
    ...
    public List<BankAccountDTO> bankAccountList(){
        ...
        List<BankAccountDTO> bankAccountDTOS = bankAccounts.stream().map(bankAccount -> {
            if(bankAccount instanceof SavingAccount) {
                return dtoMapper.fromSavingAccountDTO((SavingAccount) bankAccount);
            } else {
              CurrentAccount currentAccount = (CurrentAccount) bankAccount;
              return dtoMapper.fromCurrentAccount(currentAccount);
            }
